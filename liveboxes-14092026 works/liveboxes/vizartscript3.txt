...
sub reorder_edited_fast(boxType as Integer, boxData as String)
    ...
    ' Place edited boxes into target indexes
    boxData.Split(",", items)
    ...
    ' Fill empty indexes with unused boxes
    for i = 0 to c.ChildContainerCount - 1
